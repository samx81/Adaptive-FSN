...
https://github.com/echocatzh/MTFAA-Net/blob/main/phase_encoder.py
"""
import torch
...
# cout = 4 > after CLP, result dim will be 2
# converting complex into another complex?

# ? if cout = 2, getting useful phase information ?
